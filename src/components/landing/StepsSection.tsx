...
export function StepsSection() {
  ...
  return (
    <section ref={sectionRef} className="bg-cream" id="how-it-works">
      ...
      <div className="lg:hidden py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            <motion.h2 
              className="text-3xl sm:text-4xl font-display text-foreground mb-4 sm:mb-6"
          ...
          <div className="relative max-w-4xl mx-auto">
            {steps.map((step, index) => (
              <motion.div
                key={step.number}
                className="relative flex gap-4 sm:gap-8 pb-8 sm:pb-12 last:pb-0"
              ...
              >
                ...
                {/* Content card */}
                <div className="flex-1 bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-xl">
                  {/* Visual area */}
      ...
      <div className="hidden lg:block relative" style={{ minHeight: `${steps.length * 100}vh` }}>
        <div className="max-w-7xl mx-auto px-8">
          <div className="flex">
            {/* Sticky left side */}
            <div className="w-2/5 sticky top-0 h-screen flex items-center">
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              <div className="relative">
                {steps.map((step, index) => (
                  ...
                  >
                    {/* Timeline */}
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 rounded-full bg-foreground text-white flex items-center justify-center text-xl font-semibold z-10 flex-shrink-0">
                        {step.number}
                      </div>
                      {index < steps.length - 1 && (
                        <div className="w-px flex-1 bg-muted border-dashed border-l-2 border-muted-foreground/30 mt-4" />
