  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 rounded-full px-6 py-3 text-sm font-medium shadow-sm hover:shadow-md transition-all",
        heroLight: "bg-card text-foreground hover:bg-muted rounded-full px-6 py-3 text-sm font-medium border border-border",
        heroOutline: "bg-transparent text-foreground hover:bg-muted rounded-full px-6 py-3 text-sm font-medium border border-border",
      },
      size: {
